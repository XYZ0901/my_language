...
class parser {
    ...
    friend Expression *parseArrayLiteral(parser &);

    friend Expression *parseStringLiteral(parser &);

    friend Expression *parseBoolean(parser &);

    friend Expression *parseGroupedExpression(parser &);

    friend Expression *parseHashLiteral(parser &);
    ...
    friend Expression *parseCallExpression(parser &, Expression *);

    friend Expression *parseIndexExpression(parser &, Expression *);
...
private:
    ...
    std::vector<Expression *> parseExpressionList(const TokenType &);
